            ...
            <div class="card-body p-0">
                ...
                <div class="row g-0 d-flex justify-content-center">
                    <div class="col-10 col-sm-10">
                        ...
                        <!-- Titulo -->
                        <h1 class="fw-bold mb-0 pt-5 text-start">Editar Producto</h1>
                    
                        <form action="{{ route('productos.update', [$producto]) }}" method="post" class="py-5">
                            @csrf
                            ...
                            <div class="row d-flex justify-content-start g-0">
                                ...
                                <div class="col-12 col-sm-6 mb-2 pe-0 pe-sm-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control" id="name" placeholder="Nombre" value="{{$producto->name}}">
                                ...
                                <div class="col-12 col-sm-4 mb-2 pe-0 pe-sm-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="tipo_vender" class="form-control" id="tipo_vender" placeholder="Kg/uds." value="{{ $producto->tipo_vender }}" />
                                ...
                                <div class="col-12 col-sm-4 mb-2 px-0 px-sm-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="precio_base" class="form-control" id="precio_base" placeholder="Precio" value="{{ $producto->precio_base }}" />
                                ...
                                <div class="col-12 col-sm-4 mb-2 ps-0 ps-sm-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="pedido_minimo" class="form-control" id="pedido_minimo" placeholder="Pedido Mínimo" value="{{ $producto->pedido_minimo }}" />
                                ...
                                <div class="col-12 col-sm-12 mb-2">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="description" class="form-control" id="descripcion" placeholder="Descripción" value="{{ $producto->description }}" />
